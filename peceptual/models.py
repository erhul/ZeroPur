...
class CifarPreActResNetFeatureModel(FeatureModel):
    model: PreActResNet18

    def __init__(self, resnet18_model: PreActResNet18):
        super().__init__()

        self.normalizer = helper.Normalize(mean=(0.4914, 0.4822, 0.4465), 
                                           std=(0.2023, 0.1994, 0.2010))
        self.model = resnet18_model.eval()
...
class CifarWideResNetFeatureModel(FeatureModel):
    ...
    def __init__(self, model: WideResNet):
        super().__init__()
    ...
    def features(self, x):
        ...
        # x = self.model.bn(self.model.conv4(x))
...
class CifarResNetFeatureModel(FeatureModel):
    ...
    def __init__(self, model):
        super().__init__()
        self.normalizer = helper.Normalize()
        self.model = model.eval()
